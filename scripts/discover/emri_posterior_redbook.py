...
if __name__ == "__main__":
    ...
    z = 1.5
    M = 5e5*(1. + z)
    a = 0.  # will be ignored in Schwarzschild waveform
    mu = 1.0*(1. + z)
    p0 = 11.588332558198362
    e0 = 0.01
    x0 = 1.0  # will be ignored in Schwarzschild waveform
    qK = 2.2163526833633  # polar spin angle
    phiK = 5.458593574009178  # azimuthal viewing angle
    qS = 0.1426202854629848  # polar sky angle
    phiS = 1.6537696380160443  # azimuthal viewing angle
    dist = 11.197612957081427  # distance
    Phi_phi0 = 5.370751848256464
    Phi_theta0 = 0.0
    Phi_r0 = 1.8718034415513314

    Tobs = 2.05
    dt = 15.0
    fp = "test_run_emri_case_1_snr11.3.h5"
